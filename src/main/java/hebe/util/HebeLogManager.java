...
/**
 * Java LogManager extension for use with HEBE
 */
public class HebeLogManager extends LogManager {

    /** Logging reconfiguration in progress */
    private volatile boolean loggingReconfiguration = false;

    /**
     * Create the HEBE log manager
     *
     ...
     * done terminating the HEBE processes.
     */
    public HebeLogManager() {
        super();
    }
     ...
     * @throws      SecurityException   Caller does not have Loggihebeermission("control")
     */
    @Override
     ...
     * This allows us to continue to use logging facilities during HEBE shutdown.
     */
    @Override
    public void reset() {
    ...
    /**
     * HEBE shutdown is now complete, so call LogManager.reset() to terminate
     * the log handlers.
     */
    void hebeShutdown() {
        super.reset();
